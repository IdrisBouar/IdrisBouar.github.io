  ...
  <div class="portfolio-wrapper">
    ...
    <div class="content-wrapper">
      ...
      <div class="cyber-message">
        <p class="status">STATUS: DEVELOPMENT IN PROGRESS</p>
        <div class="terminal">
          <p>> Loading creative solutions...</p>
          <p>> Compiling experiences...</p>
          <p>> Optimizing innovation...</p>
          <p>> System will be ready soon...</p>
        </div>
      </div>
    </div>
    ...
    <!-- Footer -->
    <footer>
      <p>&copy; {{ new Date().getFullYear() }} | IdrisBouar, Built with code and creativity</p>
    </footer>
  </div>
</template>
...
.terminal p:nth-child(2) { animation-delay: 0.5s; }
.terminal p:nth-child(3) { animation-delay: 1s; }
.terminal p:nth-child(4) { animation-delay: 1.5s; }
